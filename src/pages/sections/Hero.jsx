...
const Hero = () => {
  ...
  >
    ...
    <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[55px] max-sm:leading-[82px] font-bold'>
      ...
      <br />
      <span className='text-coral-red inline-block mt-2 '>EverLasting</span>
    </h1>
    <h1 className='mt-3 font-palanquin text-8xl max-sm:text-[55px] max-sm:leading-[82px] font-bold'>
      <span className=' xl:whitespace-nowrap relative  pr-10'>
        Impressions
      </span>
      <br />
